...
export default {
  ...
  UPDATEPROFILE(state, payload){
    switch(payload.type){
      case 'imgSrc':
        state.user.avatar=payload.newValue
        state.user.imageFile=payload.imageFile
        break;
      case 'nickname':
        state.user.nickname=payload.newValue
        break;
      case 'bio':
        state.user.brief=payload.newValue
        break;
      case 'customUrl':
        state.user.shortUrl=payload.newValue
        break;
    }
  },
