<template>
  ...
  <view class="page-body">
    ...
    <view class="body-content">
      <view class="detail-left">
        ...
        <view class="upload-file">
          ...
          <view class="preview-pic upload-pic" v-else-if="tempImg&&!temAnim">
            ...
            <view class="preview-pic-right">
              ...
              <text class="text-gray mb10"> {{previewImage.width}} × {{previewImage.height}}px
              </text>
          ...
          <view class="preview-pic upload-pic audio-section" v-else-if="temAnim">
            <free-audio v-if="animFile.type.indexOf('audio') != -1" class="free-audio"
              :activeColor="$store.state.primaryColor" :loopPlay="true" :url="temAnim" audioId="1">
            </free-audio>
            <video :src="temAnim" :poster="tempImg" controls disablePictureInPicture
              controlslist="nodownload" v-if="animFile.type.indexOf('video') != -1">
            </video>
        ...
        <view class="upload-file" v-if="temAnim">
          ...
          <view class="upload-pic" v-if="temAnim&&!tempImg"
            accept="image/gif,image/png,image/jpeg,image/webp" :limit="1" :auto-upload="false"
            :on-change="uploadChange" name="image">
        ...
        <view class="put-on-sale">
          ...
          <view class="flex align-center" v-if="createForm.onSale">
            <input class="production-input" placeholder="0.0" type="number"
              v-model="createForm.price" />
            <picker class="input-suffix" @change="salePickerChange" :value="sale_index"
              :range="payTokens" :range-key="'symbol'">
        ...
        <view class="production-name">
          ...
          <input class="production-input" :placeholder="$t('erc721.placeholder1')"
        ...
        <view class="production-description">
          ...
          <input class="production-input" :placeholder="$t('erc721.placeholder2')"
        ...
        <view class="production-classification">
          ...
          <picker class="classification-select" @change="sortPickerChange" :value="category_index"
            :range="categorys" :range-key="'name'">
            <view class="uni-input">
        ...
        <view class="production-royalties">
          ...
          <view class="flex align-center">
            <input class="production-input" placeholder="10" type="number"
        ...
        <view class="production-properties">
          ...
          <view class="property-group" v-for="(property, i) in createForm.properties"
            :key="'property-group'+i">
            <view class="property left">
              <input class="production-input" v-model="property.key"
                :placeholder="$t('erc721.placeholder4')" @input="propertyInput" />
            </view>
            <view class="property right">
              <input class="production-input" v-model="property.value"
                :placeholder="$t('erc721.placeholder5')" @input="propertyInput" />
            </view>
          </view>
        </view>
        <view class="submit-section">
          <button width="100%" @tap="onSubmit()" class="submit-btn" type="success">
            {{$t('erc721.createItem')}}
          </button>
        </view>
    ...
    <mint-dialog :show="showMint" @close="showMint=false" @confirm="confirm" ref="mintDialog"
      :file="file" :animFile="animFile" :nft="nft">
    </mint-dialog>
  </view>
